...
def main():
    ...
    # extract {E}
    users_filepath = "/home/clay/workspace/firstProject/docs/files/parquet/users"
    ...
    # load {L}
    write_into_parquet(df=df_users_transformed, mode="overwrite", location="/home/clay/workspace/firstProject/docs/files/output/users")
