...
device_sch = spark.read.json("/home/clay/workspace/spark-course/docs/files/device/device_2022_6_7_19_39_24.json").schema

df_devices = spark.readStream \
    .schema(device_sch) \
    .format("json") \
    .option("header", "true") \
    .load("/home/clay/workspace/spark-course/docs/files/device/*.json")
...
df_devices \
  ...
  .format("delta") \
  .outputMode("append") \
  .option("checkpointLocation", "/home/clay/workspace/spark-course/docs/checkpoint") \
  .start("/home/clay/workspace/spark-course/docsfiles/output/devices")